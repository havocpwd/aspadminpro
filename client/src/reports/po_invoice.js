...
exports.createInvoice = async (order,orderdetail,subtotalDetail,grandTotal) => {
    ...
    function getDetailOrderItem(data) {
        var columns = ['keyname', 'shortDesc','qtyOrdered']
        var body = []
        body.push([{  fillColor: '#3A4D8F',text: 'No Produk', style: 'tableHeader'}, {fillColor: '#3A4D8F',text: 'Nama Barang', style: 'tableHeader'}, {fillColor: '#3A4D8F',text: 'QTY', style: 'tableHeader'}])
        ...
        content: [
            {
                columns: [
                    ...
                    {text: 'PO No : ' + Order.orderNo, style: 'subheader'},
                ],
            },
            {
                style: 'tableExample',
