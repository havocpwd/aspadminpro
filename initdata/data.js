...
data.menu = [
        ...
        { 
            ...
            icon: "mdi-database",
            subItems: [
                {to:"/customers",label:"Customers",icon:"mdi-account-heart"},
                {to:"/suppliers",label:"Suppliers",icon:"mdi-account-injury"},
                {to:"/payments",label:"Payments",icon:"mdi-cash"},
                {to:"/currencies",label:"Mata Uang",icon:"mdi-currency-twd"},
                {to:"/uom",label:"Uom",icon:"mdi-unity"},
                {to:"/category",label:"Category",icon:"mdi-camera-iris"},
                {to:"/products",label:"products",icon:"mdi-alpha-p-circle"},
            ],
        },
        { 
            to: "/inventory",
        ...
        { 
            ...
            subItems:
                [
                {to: "/menu",label: "Menu",icon: "mdi-dots-vertical"},
                ],
        },
        ]
...
data.partners = [
    ...
    data.payments = [
        ...
        { 
            desc: "BCA 8739127392 a/n Nila Ariyanti", 
            type: "Cash",
            duedate: "0",
            default: true,
        }
